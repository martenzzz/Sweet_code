...
def show_like_interface(screen):
    ...
    background1 = pygame.image.load('pic/2.png').convert()
...
def main():
    ...
    # 添加背景音乐
    pygame.mixer.music.load('music/music.mp3')#把这个音乐名字改成你自己准备的音乐名字
    ...
    while running:
        ...
        screen.fill((255, 255, 255))
        # 添加背景图
        background = pygame.image.load('pic/1.png').convert()
